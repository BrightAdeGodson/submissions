/**
 * Simple spell-checker. It uses the file words.txt to
...
public class SpellChecker {
	...
	public static void main(String[] args) {
		...
		try {
			// Read workds.txt in current working directory.
			String userDir = System.getProperty("user.dir");
			Path wordsFile = Paths.get(userDir,  "src", "words.txt");
			words = new Scanner(new File(wordsFile.toString()));
